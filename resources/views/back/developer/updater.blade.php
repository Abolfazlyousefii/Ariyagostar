                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-info" role="alert">
                                    <span>ورژن PHP فعلی سرور شما: {{ $phpVersion }}</span>
                                </div>

                                @if($updateType == 'experimental')
                                    <div class="alert alert-danger" role="alert">
                                        <i class="feather icon-alert-triangle mr-1 align-middle"></i>
                                        <span>شما در کانال آزمایشی (Experimental) هستید. این نسخه‌ها ممکن است ناپایدار باشند و برای تست مناسب هستند. قبل از آپدیت حتما یک نسخه بک‌آپ در سرور تهیه نمایید.</span>
                                    </div>
                                @else
                                    <div class="alert alert-danger" role="alert">
                                        <i class="feather icon-alert-triangle mr-1 align-middle"></i>
                                        <span>
                                        قبل از آپدیت حتما یک نسخه بک آپ کامل در سرور تهیه بفرمایید. در صورت بروز مشکل به هنگام بروز رسانی بدون بکاپ سایت قابل بازیابی نخواهد بود .
                                        </span>
                                    </div>
                                @endif

                                <div class="alert alert-info" role="alert">
                                    <strong>کانال بروزرسانی:</strong> {{ ucfirst($updateType) }}
                                    <a href="{{ route('admin.developer.showUpdater', ['type' => $updateType == 'stable' ? 'experimental' : 'stable']) }}" class="btn btn-sm btn-outline-primary float-right">
                                        تغییر به {{ $updateType == 'stable' ? 'آزمایشی' : 'پایدار' }}
                                    </a>
                                </div>

                                @if($repositoryAvailable)
                                    <div class="alert alert-info" role="alert">
                                        <span>آخرین آپدیت موجود برای ورژن PHP شما: {{ $versionAvailable }}</span>
                                    </div>

                                    <div class="alert alert-warning" role="alert">
                                        <span>نکته مهم: برای جلوگیری از خطا، آپدیت‌ها را مرحله‌به‌مرحله انجام دهید و بعد از هر آپدیت، دستورات بعد از بروزرسانی را اجرا کنید.</span>
                                    </div>
                                    ...
                                    @else
                                        <div class="alert alert-success" role="alert">
                                            <span>شما از آخرین نسخه ی موجود نرم افزار برای ورژن PHP فعلی استفاده میکنید.</span>
                                        </div>
                                    @endif
                                @else
                                    <div class="alert alert-warning" role="alert">
                                        <i class="feather icon-alert-circle mr-1 align-middle"></i>
                                        <span>مخزن آپدیت در حال حاضر در دسترس نیست. شما از آخرین نسخه ی موجود نرم افزار استفاده میکنید.</span>
                                    </div>
                                @endif

                                <button data-action="{{ route('admin.developer.checkNextPhpUpdates') }}" id="check-next-php" type="button" class="btn btn-lg btn-info mb-1 waves-effect waves-light"><i class="feather icon-search mr-1"></i> بررسی آپدیت در PHP بالاتر </button>

                                <div id="next-php-upgrade" style="display: none;" class="alert alert-danger mt-2" role="alert">
                            ...
                            <ul class="activity-timeline timeline-left list-unstyled">
                                <li>
                                    ...
                                    <div class="timeline-info">
                                        <p class="font-weight-bold mb-0">نسخه 1.18</p>
                                        <p class="font-small-3">- اضافه شدن ویجت صفحه سفارشی</p>
                                        <p class="font-small-3">- اضافه شدن امکان ویرایش سفارشات ثبت شده توسط مشتری</p>
                                        <p class="font-small-3">- اضافه شدن امکان غیرفعال سازی ایندکس صفحات</p>
                                        <p class="font-small-3">- ارسال پیامک زمان موجود شدن محصول به کاربران لیست (موجود شد به من اطلاع دهید)</p>
                                        <p class="font-small-3">- آپدیت لاراول به نسخه 10</p>
                                        <p class="font-small-3">- رفع برخی از باگ های جزئی</p>
                                        <p class="font-small-3">- بروزرسانی کتابخانه ها</p>
                                    </div>
                                    <small class="text-primary">15 تیر 1404</small>
                                </li>
                                <li>
                                    <div class="timeline-icon bg-success">
                                        <i class="feather icon-chevron-left font-medium-2 align-middle"></i>
                                    ...
                                    <div class="timeline-info">
                                        <p class="font-weight-bold mb-0">نسخه 1.17</p>
                                        <p class="font-small-3">- اضافه شدن ویجت تخفیف زماندار</p>
                                        <p class="font-small-3">- اضافه شدن تخفیف دسته جمعی برای محصولات</p>
                                        <p class="font-small-3">- اضافه شدن تخفیف ارسال رایگان</p>
                                        <p class="font-small-3">- رفع برخی از باگ های جزئی</p>
                                        <p class="font-small-3">- بروزرسانی کتابخانه ها</p>
                                    </div>
                                    <small class="text-primary">17 اسفند 1403</small>
                                </li>
                                <li>
                                    <div class="timeline-icon bg-success">
                                        <i class="feather icon-chevron-left font-medium-2 align-middle"></i>
                                    ...
                                    <div class="timeline-info">
                                        <p class="font-weight-bold mb-0">نسخه 1.16</p>
                                        <p class="font-small-3">- بهبود ویجت های صفحه اول</p>
                                        <p class="font-small-3">- اضافه شدن ویجت اسلایدر تمام صفحه</p>
                                        <p class="font-small-3">- رفع برخی از باگ های جزئی</p>
                                    </div>
                                    <small class="text-primary">10 تیر 1403</small>
                                </li>
                                <li>
                                    <div class="timeline-icon bg-success">
                                        <i class="feather icon-chevron-left font-medium-2 align-middle"></i>
                                    ...
                                    <div class="timeline-info">
                                        <p class="font-weight-bold mb-0">نسخه 1.15</p>
                                        <p class="font-small-3">- اضافه شدن درگاه تومن</p>
                                        <p class="font-small-3">- اضافه شدن پنل اس ام اس ایده پردازان</p>
                                        <p class="font-small-3">- رفع برخی از باگ های جزئی</p>
                                    </div>
                                    <small class="text-primary">3 آیان 1402</small>
                                </li>
                                <li>
                                    <div class="timeline-icon bg-success">
                                        <i class="feather icon-chevron-left font-medium-2 align-middle"></i>
...
@push('scripts')
    ...
    <script>
        $(document).on('click', '#check-next-php', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var messageDiv = $('#next-php-upgrade');
                    if (response.hasNextUpgrade) {
                        messageDiv.html('<i class="feather icon-alert-triangle mr-1 align-middle"></i><strong>آپدیت موجود!</strong> نسخه ' + response.nextVersion + ' برای PHP ' + response.nextPhpVersion + '<p>برای     بروز رسانی ابتدا نیاز هست در سرور نسخه php را به </p>'+response.nextPhpVersion+'<p>افزایش دهید سپس صفحه را رفرش نمایید </p>');
                        messageDiv.removeClass('alert-success').addClass('alert-primary');
                    } else {
                        messageDiv.html('<i class="feather icon-check mr-1 align-middle"></i>هیچ آپدیت جدیدی در PHP بالاتر یافت نشد. (فعلی: ' + response.currentVersion + ')');
                        messageDiv.removeClass('alert-primary').addClass('alert-success');
                    }
                    messageDiv.show();
                },
                error: function(xhr) {
                    console.error('AJAX Error:', xhr.responseText); // DEBUG
                    toastr.error('خطا در بررسی آپدیت PHP بالاتر');
                }
            });
        });
    </script>
